-- Please note, we commented out the table inserts for bootstrapping the db
-- since it interfered with inserting all of our mockaroo data
DROP DATABASE IF EXISTS moonshotlabs;
...
(
    hyperlink VARCHAR(500) PRIMARY KEY,
    title VARCHAR(75),
...
--    VALUES ('098-02-6789', 'Basic', 5, 70, 'Marco', 'Milton', 20, 'mmilton5');
...
--    VALUES ('Over/Under', 'Placed an Over/Under Bet on Boston vs the Rays', 20.00, 10.00, 2.000, 1, '098-02-6789');
